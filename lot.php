...
if (!isset($id)) {
    ...
    $sql = "SELECT l.title, l.image, l.description, l.expire_datetime, c.category, l.start_price + l.price_increment * COUNT(b.id) AS price, l.start_price + l.price_increment * (COUNT(b.id) + 1) AS min_bid FROM lots l "
